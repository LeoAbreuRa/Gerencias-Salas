...
public class ReservaDaoImpl extends BaseDaoImpl<Reserva, Long> implements ReservaDao {
    ...
    public List<Reserva> contagemSala(){
    ...
    public static void main(String[] args) {
        ...
        List todas = daoImpl.totalMesSala(session);
        System.out.println(todas);
        session.close();
    }

    @Override
    public List<GraficoReservaPorTotalMesSala> totalMesSala(Session session) throws HibernateException {
        Object[] item;
